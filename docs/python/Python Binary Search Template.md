---
title: "[Python] Powerful Ultimate Binary Search Template. Solved many problems - Discuss"
source: "https://leetcode.com/discuss/post/786126/python-powerful-ultimate-binary-search-t-rwv8/"
author:
published:
created: 2026-06-20
description: "#  >> IntroBinary Search is quite easy to understand conceptually. Basically, it splits the search space into two halves and only keep the half that proba"
tags:
  - "clippings"
---
...
[Binary Search](https://leetcode.com/discuss/topic/binary-search/) [Career](https://leetcode.com/discuss/topic/career/)
...
Nearly every one have used the [Multiplication Table](https://leetcode.com/link/?target=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FMultiplication_table). But could you find out the `k-th` smallest number quickly from the multiplication table? Given the height `m` and the length `n` of a `m * n` Multiplication Table, and a positive integer `k`, you need to return the `k-th` smallest number in this table.
...
[Gary Bao](https://leetcode.com/u/gary16/)

Aug 12, 2020

Post like this worths 100 times more than a **one-line Python Solution beats 99% of time**
...
Excellent work! Many people think sorted array is a must to apply binary search, which is not 100% correct. In some cases, there is no such array, or the array is not sorted, or the element are not even comparable! What makes binary search work is that there exists a function that can map elements in left half to True, and the other half to False, or vice versa. If we can find such a function, we can apply bs to find the boundary (lower\_bound for example). For the interval notation, Professor E.W. Dijkstra favors left closed right open [interval](https://leetcode.com/link/?target=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FInterval_\(mathematics\)) notation and explained why we benefit from this notation in his [post](https://leetcode.com/link/?target=https%3A%2F%2Fwww.cs.utexas.edu%2Fusers%2FEWD%2Ftranscriptions%2FEWD08xx%2FEWD831.html) which was published in 1982.
...
I had an interview today and just my luck I got the **First Bad Version** problem. I thought, "Wow! I read this post and did this *exact* problem yesterday!" Then, I stupidly wrote **mid-1 instead of mid+1** and got stuck in an infinite loop, lol. I managed to fix it after walking through some examples and I got through the problem though I feel really silly for not getting it immediately after studying it literally the day before, lol. All is good though, I know I won't make that mistake again. Failure is the best teacher.
...
for me.. best article so far...on leetcode

70

Reply

So much better than leetcode's joke of a program on BS.
...
[Woke Wagey](https://leetcode.com/u/wokewagey99/)

Nov 17, 2022

How to solve [https://leetcode.com/problems/find-minimum-in-rotated-sorted-array-ii/](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array-ii/) using the template?
...
Does anyone feels dumb:(? Even though binary search is a easy understanding algo but the index +1 and inclusive stuff is tricky on each questions.

32

Reply

Thanks for the awesome summary here! But could you alter this template to solve the problem that you want to find the largest k such that the condition meets. Like [https://leetcode.com/problems/divide-chocolate/](https://leetcode.com/problems/divide-chocolate/) you want to maximize the value you can get?
...
Hey [@zhijun\_liao](https://leetcode.com/zhijun_liao), just the thing I was looking for. Thank you for all the efforts.
